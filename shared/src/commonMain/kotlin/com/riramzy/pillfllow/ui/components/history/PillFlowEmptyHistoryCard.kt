...
@Composable
fun PillFlowEmptyHistoryCardPreview() {
    PillFlowTheme {
        PillFlowEmptyHistoryCard(modifier = Modifier.padding(15.dp))
    }
}

@Preview(uiMode = UI_MODE_NIGHT_YES, showBackground = true, backgroundColor = 0xFF000000)
@Composable
fun PillFlowEmptyHistoryCardPreviewDark() {
    PillFlowTheme {
        PillFlowEmptyHistoryCard(modifier = Modifier.padding(15.dp))
    }
}